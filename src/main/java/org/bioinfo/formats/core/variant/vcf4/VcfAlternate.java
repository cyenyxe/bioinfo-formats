package org.bioinfo.formats.core.variant.vcf4;

public class VcfAlternate {
	private String id;
	private String description;

	public VcfAlternate(String filterLine) {
	...
	public VcfAlternate(String id, String description) {
		this.id = id;
